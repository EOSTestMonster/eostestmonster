...
from eosapi.httpapi.http_client import HttpClient
...
class Client(HttpClient):
    ...
    # To get the full return value of this function,
    # you need to set the filter_on parameter when the node is started again
